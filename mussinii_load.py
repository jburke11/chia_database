...
try :
    """
    fp = open( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii_functional_annotation.txt" , "r" )
    count = 0
    for line in fp:
    ...
    hc_models = []
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/n_mussinii.hc.gene_models.gff3" ) as hc_gff :
        for line in hc_gff :
    ...
    count = 0
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii_working_models.gff3" ) as in_gff :
        for line in in_gff :
            lst = line.rstrip ( ).split ("\t" )
            if len(lst) > 1 and lst [2] == "mRNA" :
                scaffold = lst [0]
...
##############################################
    # start func anno
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii_functional_annotation.txt" ) as in_func :
    ...
    go_not_found = 0
    count = 0
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii.pep.fa.tsv" , "r" ) as in_tsv :
    ...
    for record in SeqIO.parse ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii.cds.fa" , "fasta" ) :
    ...
    cdna = 0
    pep = 0
    for record in SeqIO.parse ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii.cdna" , "fasta" ) :
        collection.update_one ( { "transcript_id" : record.id } , { "$set" : { "cdna" : str ( record.seq ) } } )
        cdna += 1
    print ( cdna == 47924 )


    for record in SeqIO.parse ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii.pep.fa" , "fasta" ) :
    ...
    ssr_dict = { }
    collection = db.ssr
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii.ssr" , "r" ) as in_ssr :
        for line in in_ssr :
            line = line.rstrip ( ).split ( )
    ...
    """
    collection = db.genes
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/diamond_results_title.txt" , "r" ) as in_file :
...
# add in pfam
    """
    x = 0
    with open ( "/Users/burkej24/Desktop/catnip/catnip_data/mussinii/mussinii_pfam.tsv" , "r" ) as in_pfam :
